...
const CSVSPage: React.FC<PageProps> = () => {
  return (
    ...
    <h1>Tisakorean, 100 Gecs, and Liturgy</h1>
		<div><a href="/">← Home</a></div>
		<p>
		On December 14, 2023 I saw <a href="https://pitchfork.com/news/100-gecs-tisakorean-and-liturgy-to-play-new-york-show-for-pitchfork-presents/">this concert hosted by Pitchfork Media at the Knockdown Center in Brooklyn</a> where the black metal band Liturgy, the rapper Tisakorean, and the hyperpop duo 100 Gecs performed. The concert was fun, the crowd was into it, and I enjoyed all three sets. 
		</p>
		<p>
		...
		<p>
		All of Tisakorean’s lyrics are in this kind of register of “I’m wearing such-and-such outfit, I’m about to see what’s up with this girl, I think she thinks I look good, I’m about to do this dance”. Oh, and talking about being “silly”. He has a <a href="https://soundcloud.com/skrrt-lettuce/tisakorean-silly-bandana-intro">silly bandana</a>, <a href="https://www.youtube.com/watch?v=1IxYaOLtnqc">a silly shirt</a>, and is all-in-all <a href="https://www.youtube.com/watch?v=GkP9MI9mbjo">a silly dude</a>. 
		</p>
		<p>
		...
		<h3>Liturgy</h3>
		<p>
		Unlike these other two artists, a philosophical interpretation of Liturgy’s music is not a projection, as the band’s frontwoman Haela Hunt-Hendrix has written <a href="https://arkwork.org/">an extensive body of philosophical writings</a> which are woven into the band’s music. Liturgy’s philosophy has at times taken a variety of overlapping names such as “transcendental qabala”, “ark work”, and, most recently, “apocalyptic humanism”.
		</p>
		<p>
		Liturgy’s music is a merging of the “extreme” genre of black metal with a kind of high Wagnerian operatic sensibility. The thesis of the band’s music, <a href="https://static1.squarespace.com/static/57044839b09f95d1f342ce25/t/575201a58a65e24600087b3b/1464992166180/Transcendental+Black+Metal+%28BMTS+vol.+1+-+Hideous+Gnosis%29+.pdf">outlined in manifestos</a>, is to take the popular form with the closest relationship to transcendence — held to be black metal, with its (sometimes authentically) spiritual relationship to the demonic, famously inspiring murder and church burnings — and taking the striving for transcendence further, to the point where it accesses the positively transformative and divine.
		</p>
		<p>
		...
		<p>
		One can perhaps dream of a restored culture that is truly a <i>culture</i>, in the sense of cultivating human souls, rather than an expression of what grabs people’s attention the quickest in a market. It would seem that Liturgy aims to save a world of overproduction by rejecting poptimism — we have to go beyond the shallow delirium of pop in favor of cultivation. Rather than the Warholian “everyone is a star”, the utopia to wish for is “everyone is a genius”.
		</p>
		<p>
...
export const Head: HeadFC = () => <title>Tisakorean, 100 Gecs, and Liturgy</title>
