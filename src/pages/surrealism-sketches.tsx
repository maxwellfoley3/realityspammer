...
const WhatIsAiHarmony: React.FC<PageProps> = () => {
  return (
    ...
    <h1>Sketches towards the return of Surrealism</h1>
		...
		<p>
		Surrealism is more radical than Marxism because: in the case of Marxism, we are told to liberate the workers from their oversight by the factory managers, because the workers represent the productive force of the world, and their activity is captured by the managers. But Surrealism aims to accomplish the same process within the mind — liberate the pure productivity of the desiring unconscious from its oversight by the ego. Surrealism liberates productive activity itself, rather than simply the social class who is assigned to it. Surrealism sees everywhere a divine proletariat flattened and sanded down by a Realist bourgeois.
		</p>
		<p>
		The other important figure exiled by Breton was Georges Bataille, who wrote a three-volume work of political economy outlining what he called a theory of “general economy” — general because it encompasses a wider range of phenomena than capitalist or Marxist economy. Surrealists are asked to understand a “psychic economy” of debts and allegiances — the conversion between a basket of goods given as a gift and the feelings reciprocated and exchange of roles in the unconscious. In our return to Surrealism, we want to deepen our understanding of figures like Bataille to understand a <b>divine economy</b> which would not only be used to understand capitalist economies, but all economies that have existed before, existing among animals, even, and potential economies of the future.
		</p>
		<p>
