...
const CSVSPage: React.FC<PageProps> = () => {
  return (
    ...
    <h1>Zoomer Schopenhauer (Dialogues no. 1)</h1>
    ...
    <p>
      ...
      <p>
        ...
        <p>
        Elite theory and mass psychology also put the myths underpinning modern mass democracy under serious pressure as well, as the idea of a rational voter rather than someone who votes in partisan and tribal ways is actually the way the system functions, with individual elections being determined by punitive voting that almost never has a clear relation to actual political causes of downturns, and tends to be in a short memory timespan of six months to the election. 
        </p>
        <p>
        ...
        <h3>Zoomer Schopenhauer:</h3>
        <p>
        Networking and producing accurate evidence based diagnostics about the problems of the system. My inspiration comes from Lenin in one positive and one negative sense in a way I am currently writing about for a long substack series. The positive sense is derived from the classic of organisation theory: organisational weapons by Selznick. Which details the strategies of the combat party which I think any movement would have to adopt from a tactical point of view.
        </p>
        <p>
...
export const Head: HeadFC = () => <title>Zoomer Schopenhauer (Dialogues no. 1)</title>
